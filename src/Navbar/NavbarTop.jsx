...
function NavbarTop() {
  return (
    <div className='navbartop'>
        <div className='navbartop-icons'>
        <li>
           <svg height={"24px"} width={"24px"} viewBox='0 0 26 32'>
        ...
        <li>
           <svg height={"24px"} width={"24px"} viewBox='0 0 39 33'>
        ...
        <div className='navbartop-text'>
            <p className='border-right-text'>Help</p>
            <p className='border-right-text'>Join Us</p>
            <p>Sign In</p>
        </div>
    </div>
  )
